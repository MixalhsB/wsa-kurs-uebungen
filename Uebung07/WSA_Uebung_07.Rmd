...
## Aufgabe H: Export des Remote-Repositorys als ZIP-Archiv

1. Navigiere in deinem Browser auf die Webseite mit der URL  
   \vspace{0.3em}
   `https://github.com/<GitHub-Username>/wsa-u7-abgabe`  
   \vspace{0.3em}
   wobei natürlich `<GitHub-Username>` zuerst wieder durch deinen persönlichen GitHub-Benutzernamen ersetzt werden muss.

2. Du siehst jetzt eine Übersicht zu deinem Repository.  
   \vspace{0.3em}
   Klicke auf den Button mit der Aufschrift „<> Code“, dann auf „Download ZIP“.  
   Dadurch wird dein Repository als ZIP-Archiv exportiert und heruntergeladen.

3. Finde das heruntergeladene ZIP-Archiv auf deinem PC.  
   \vspace{0.3em}
   Es wird jetzt standardmäßig den Dateinamen `wsa-u7-abgabe-main.zip` haben.

4. Benenne das ZIP-Archiv nun manuell um in `wsa-u7-abgabe-main_<Vorname>_<Nachname>.zip`.  
   \vspace{0.3em}
   Dabei soll natürlich `<Vorname>` durch deinen Vornamen und `<Nachname>` durch deinen Nachnamen ersetzt werden.
...
- `wsa-u7-abgabe-main_<Vorname>_<Nachname>.zip`
